...
def test_index():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # dbg
        print("Homo_sapiens_assembly38.fasta.fai Homo_sapiens_assembly38.rev.1.bt2 Homo_sapiens_assembly38.rev.2.bt2 Homo_sapiens_assembly38.1.bt2 Homo_sapiens_assembly38.2.bt2 Homo_sapiens_assembly38.3.bt2 Homo_sapiens_assembly38.4.bt2", file=sys.stderr)
